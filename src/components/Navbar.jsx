    ...
    <>
            ...
            <div className="flex flex-col justify-center items-end gap-[5px] w-7">
              <span
                className={`block h-[1.5px] bg-white transition-all duration-300 ${
                  isOpen ? "w-7 rotate-45 translate-y-[6.5px]" : "w-7"
                }`}
              />
              <span
                className={`block h-[1.5px] bg-[#D4A373] transition-all duration-300 ${
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          {/* Side Drawer — 1/4 width from right */}
          <motion.div
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            ...
            <div className="flex items-center justify-between px-8 pt-8 pb-6 border-b border-white/10">
              ...
              >
                <span className="text-xs tracking-[0.2em] uppercase font-medium">Close</span>
            ...
            <div className="flex flex-col px-8 pt-10 gap-2 flex-1">
              ...
              <motion.div
                ...
                className="space-y-2"
              >
                <p className="text-[#D4A373] text-xs tracking-[0.2em] uppercase font-semibold mb-3">Get in Touch</p>
                <p className="text-white/50 text-sm font-light">Sri Lanka</p>
                <p className="text-white/50 text-sm font-light">info@isharatea.com</p>
              </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <p className="text-white/40 text-xs tracking-[0.2em] uppercase">Ishara Tea & Spices</p>
              </div>
            </motion.div>
          </motion.div>
          </>
