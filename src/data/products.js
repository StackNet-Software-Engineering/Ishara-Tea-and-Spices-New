...
export const categories = [
    {
        ...
        subCategories: [
            {
                id: "flavoured-black",
                title: "Flavoured Black Teas",
                description: "Black Ceylon tea blended with fruit, floral, or spice flavours. Bold base with added character.",
                items: [
                    {
                        id: "ceylon-tea-1",
            ...
            },
            {
                ...
                description: "Light green Ceylon base with added fruit or herbal flavours. Bright and refreshing.",
                items: [
                    {
                        id: "ceylon-tea-7",
            ...
            },
            {
                ...
                description: "Unoxidised Ceylon green tea. Clean, vegetal, antioxidant-rich.",
                items: [
                    {
                        id: "ceylon-tea-21",
                        name: "Green Tea",
            ...
            {
                id: "graded-black",
                title: "Graded Black Teas",
                description: "Traditional trade-grade Ceylon black teas — BOP, OP, PEKOE, BOPF. Defined by leaf size and cut.",
                items: [
                    {
                        id: "ceylon-tea-22",
                        name: "PEKOE-1",
            ...
            {
                id: "specialty-rare",
                title: "Specialty & Rare Teas",
                description: "Premium single-flush teas — Silver Tips, Golden Tips, White Tips, Purple Tea. Low production, high value.",
                items: [
                    {
                        id: "ceylon-tea-3",
            ...
            {
                id: "herbal-wellness",
                title: "Herbal & Wellness Teas",
                description: "Spiced, herb-forward, or wellness blends. Lower caffeine or caffeine-free options.",
                items: [
                    {
                        id: "ceylon-tea-6",
                        name: "Lemon Grass",
        ...
        // Flat list for backward compatibility (all teas, no sub-grouping)
        get items() {
            return this.subCategories.flatMap(sc => sc.items);
        }
    },
    {
        id: "spices",
